...
find "$ROMS_DIR" -maxdepth 2 -type f -not -path "*/\.*" | while read -r rom_file; do
    ...
    year=""
    genre=""
    hide="no" # Default to show games with no metadata
